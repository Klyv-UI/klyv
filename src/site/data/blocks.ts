...
export const blocks: BlockEntry[] = [
  ...
  },
  {
    ...
    blurb:
      'A team admin panel that works end to end: sort, select and page the members table, invite someone through a validated dialog, change roles, and undo a removal from the toast.',
    uses: [
      'DataTable',
      'Modal',
      'Field',
