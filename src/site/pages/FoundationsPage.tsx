 ...
 * spends its one accent colour, and handles focus.
 */
    ...
    <div className="flex flex-col gap-8">
      <header className="flex flex-col gap-2.5">
        ...
        <Text size="body" weight="medium" tone="soft" leading="normal" className="max-w-[76ch]">
          Six rules the whole library obeys. They explain why the tokens are shaped the way they
          are, and they are the reason a new component almost never needs a new value.
        </Text>
      </header>

      <Section
        title="1 — Surfaces stack, they do not tint"
      ...
      >
        ...
        <Note>
          Only four elevations exist. Everything else separates with a <Code>line</Code> hairline,
          which is why cards can sit 16px apart without the page feeling noisy.
        </Note>
      </Section>

      <Section
        title="2 — Three inks, always in the same order"
      ...
      <Section
        title="3 — One accent, spent sparingly"
      ...
      <Section
        title="4 — Radius grows with the container"
      ...
      <Section
        title="5 — Interaction is a colour change"
      ...
      <Section
        title="6 — Focus is global and visible"
      ...
      >
        ...
        <Note>
          Icon-only controls take a required <Code>label</Code>, which becomes both the accessible
          name and the tooltip. There is no way to render one without a name.
        </Note>
      </Section>
    </div>
  )
